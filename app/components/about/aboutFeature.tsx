...
const AbFeatures = () => {
    ...
    return (
        ...
        <section
            id='features'
            className="relative z-10 overflow-hidden flex justify-center items-center text-center  bg-slate-50 "
        >
            ...
            <div className="py-12 space-y-12">
                <div className="px-14 pt-12 space-y-12 pb-4 text-center ">
                    <h2 className="text-3xl font-bold !leading-tight text-black sm:text-4xl md:text-[35px] tracking-wide capitalize">
