...
const features = [
    {
        ...
        icon: <FaRegLightbulb />,
        name: 'Vision',
        desc: 'To be a world class hydrocarbon key player, maximizing stakeholders’ benefits, cultivating sustainability, creating value and d nurturing localization.'
    },
    {
        id: 2,
        icon: <HiBadgeCheck />,
    ...
    },
    {
        ...
        name: 'Quality',
        desc: 'Quality consistency is vital for us as we know there are no shortcuts when it comes to providing customers with consistent and reliable, quality products.'
    },
]
...
const Features = () => {
    ...
    return (
        ...
        <section
            id='features'
            className="relative z-10 overflow-hidden  flex justify-center items-center text-center mb-2 bg-gray-50 "
        >
            ...
            <div className=" pt-20 pb-20 p-4 w-3/4	">
                <div className="grid gap-14 md:grid-cols-3 md:gap-5">
                    <div className="rounded-xl bg-white p-6 text-center shadow-2xl">
                        <div
                            className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full bg-teal-600 shadow-2xl ">
                    ...
                    <div data-aos-delay="150" className="rounded-xl bg-white p-6 text-center shadow-2xl">
                        <div
                            className="mx-auto flex h-16 w-16 -translate-y-12 transform items-center justify-center rounded-full shadow-lg bg-teal-600 shadow-teal-500/40"
                            >
                ...
                <div data-aos-delay="300" className="rounded-xl bg-white p-6 text-center shadow-2xl">
                    <div
