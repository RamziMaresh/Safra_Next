                ...
                <div className='flex flex-wrap m-auto w-full justify-center items-center '>
                    {
                        features.map((feature) =>  {
                            return (
                                <div >
                                    <div key="feature" className='flex flex-col cursor-grab justify-center items-center mb-8 space-y-4 hover:bg-[rgba(0,0,0,.015)] group rounded-3xl duration-200 transition p-6'>
