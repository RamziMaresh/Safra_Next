              ...
              <div>
                ...
                <div className="mb-10 flex flex-wrap items-center justify-between border-b border-body-color border-opacity-10 pb-4 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-2">
                    ...
                    >
                      Download Full Aliphatic Solvents
                    </a>
                  </div>
                </div>
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Safra aliphatic are one of the main stream solvents.
                    These come mainly from oil streams purely by distillation.
                    Diagrammatized products are more highly refined materials which are virtually aromatic free
                    and made by additional chemical treatment, or by chemical processes, achieving lower
                    toxicity and very low odor. Safra provides its customers many aliphatic solvents
                    both generic and customized even on customers own specifications.
                    Few of Safra generic aliphatic solvents are mentioned below:
                  </p>
